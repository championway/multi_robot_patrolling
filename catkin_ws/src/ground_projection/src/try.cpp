...
public:
  ...
  : nh_("~")
  {
    ...
    nh_.param<std::string>("config_file_name",config_file_name_,"test");
    ...
    if (!fin.good())
    {
      ...
      h_file_ = ros::package::getPath("duckietown") + "/config/" + config_name_ + "/calibration/camera_extrinsic/test.yaml";
